          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center gap-4 mt-6">
              <div className="flex items-center border border-zinc-300 rounded-lg">
                ...
                <span className="px-6 py-2 font-semibold text-zinc-800 text-center min-w-12">
                  {quantity}
                </span>
            ...
            <div className="flex gap-4 mt-8">
              <button
                ...
                className="flex-1 px-6 py-3 bg-orange-600 text-white rounded-xl cursor-pointer hover:bg-orange-700 transition font-medium"
              >
                Add to Cart
              </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {relatedProducts.map((p) => (
              <Link
                key={p.id}
                to={`/product/${p.id}`}
                className="group bg-white border border-zinc-200 rounded-xl overflow-hidden hover:shadow-md transition cursor-pointer"
              >
